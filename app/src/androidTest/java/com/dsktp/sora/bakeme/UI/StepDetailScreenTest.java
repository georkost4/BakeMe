...
public class StepDetailScreenTest {
    ...
    @Test
    public void stepDetailScreenTest() {
        ...
        ViewInteraction recyclerView2 = onView(
                allOf(withId(R.id.rv_recipe_step_description),
                        childAtPosition(
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.tv_step_full_description_tag), withText("Step Description"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.fragment_placeholder_recipe_list),
                                        0),
                                1),
                        isDisplayed()));
        textView.check(matches(withText("Step Description")));

        ViewInteraction frameLayout = onView(
                allOf(withId(R.id.fragment_placeholder_nav_bar),
                        childAtPosition(
                                childAtPosition(
